...
pub(crate) use host::{
    ...
    search_document, search_progress, set_dirty, set_document_encoding, set_document_line_ending,
    undo_lines, write_settings, Draft, EditApplied, OpenedDocument, ReadLines, SearchProgress,
    SpliceEdit,
};
