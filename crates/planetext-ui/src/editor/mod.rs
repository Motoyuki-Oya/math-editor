...
pub use session::{
    ...
    release_doc, set_doc_file_size, set_doc_path, set_line_count, set_on_change, set_on_far_copy,
    set_on_focus, set_on_missing, set_on_tail, show_tail, stats, take_flush, url_at_caret,
